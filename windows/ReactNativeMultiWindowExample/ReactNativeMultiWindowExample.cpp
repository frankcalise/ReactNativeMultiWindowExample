// ReactNativeMultiWindowExample.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "ReactNativeMultiWindowExample.h"
...
_Use_decl_annotations_ int CALLBACK WinMain(HINSTANCE instance, HINSTANCE, PSTR /* commandLine */, int showCmd) {
  ...
  appWindow.Title(L"ReactNativeMultiWindowExample");
